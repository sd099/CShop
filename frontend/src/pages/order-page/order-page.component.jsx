...
import { getOrderDetails, deliverOrder } from "../../redux/order/order.actions";
import {
  ORDER_PAY_RESET,
  ORDER_DELIVER_RESET,
...
const OrderPage = ({ match, history }) => {
  ...
  return loading ? (
    ...
    <>
      <Container className="order-view-container">
          ...
          <Col md={8} className="mb-4">
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                ...
                {order.isPaid ? (
                  <Message variant="success">
                    Paid on {moment(order.paidAt).format("YYYY/MM/DD")}
                  </Message>
                ) : (
